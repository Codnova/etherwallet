...
es.data = {
  ...
  /* Navigation*/
  NAV_YourWallets:      'Tus Monederos',
  NAV_AddWallet:        'Agregar Monedero',
  NAV_GenerateWallet:   'Generar Monedero',
  NAV_BulkGenerate:     'Generar en lote',
  NAV_SendEther:        'Enviar Ether',
  NAV_SendTokens:       'Enviar Tokens',
  NAV_Offline:          'Enviar Sin Conexión',
  NAV_WithdrawDAO:      'Retirar DAO',
  DAO_TitleLong:        'Retirar Tus Tokens DAO Por Ether',
  NAV_ClaimDGD:         'Reclamar DGD',
  DGD_TitleLong:        'Reclama Tus Tokens DGD',
  NAV_MyWallets:        'Mis Monederos',
  NAV_ViewWallet:       'Ver Detalles De Tu Monedero',
  NAV_Help:             'Ayuda',
  ...
  x_Save:               'Guardar',
  x_Cancel:             'Cancelar',
  x_AddessDesc:         'Conocerás esto como tu número de cuenta o tu "Llave Pública". Esto es lo que debes enviarle a otras personas para que te puedan enviar ETH. El icono es una forma sencilla y divertida de reconocer tu dirección, no hay dos iguales.',
  x_PrivKey:            'Llave Privada (desencriptada)',
  x_PrivKeyDesc:        'Esta es la versión de texto de tu llave privada desencriptada, lo que significa que no se necesita ninguna contraseña. Si alguien encuentra tu llave privada desencriptada, podrían acceder fácilmente a tus fondos. Por esta razón se recomienda mantener la llave privada encriptada.',
  x_Keystore:           'Llavero/Archivo JSON (Recomendado · Encriptado · Formato usado por Mist/Geth)',
  x_KeystoreDesc:       'Este llavero / Archivo JSON Es el mismo formato usado por Mist y Geth Para que puedas importar allí tus monederos con facilidad. Es el archivo recomendado para descargar y tener una copia de respaldo.',
  x_Json:               'Archivo JSON (desencriptado)',
  x_JsonDesc:           'Este es el formato JSON encriptado de tu llave privada. Esto significa que no necesitas usar contraseñas, pero cualquiera que se apodere de este archivo será capaz de acceder a tus fondos.',
  x_PrintShort:         'Imprimir',
  x_Print:              'Imprimir Monedero de Papel',
  x_PrintDesc:          'Consejo: Presiona imprimir y guardar como PDF para tener una copia digital de tu monedero de papel.',
  x_CSV:                'Archivo CSV (desencriptado)',
  x_TXT:                'Archivo TXT (desencriptado)',

  /* Header */
  MEW_Warning_1:        'Verifica siempre la URL del sitio web antes de acceder a tu monedero para evitar ataques de Phising.',
  CX_Warning_1:         'Asegúrate de tener copias de seguridad externas (fuera de tu PC principal) de todos tus monederos generados con esta extensión.',
  MEW_Tagline:          'Monedero Ether creado con código abierto JavaScript del lado del cliente',
	CX_Tagline:           'Extensión de Chrome de Monedero Ether creado con código abierto JavaScript del lado del cliente',

  /* Footer */
  FOOTER_1:             'Una herramienta de código libre, basada en Javacript con programación del lado del cliente, para generar monederos Ether y enviar transacciones.',
  FOOTER_2:             'Apreciamos cualquier donación:',
  FOOTER_3:             'Monederos generados localmente por',

  /* Sidebar */
  sidebar_AccountInfo:  'Información de la Cuenta:',
  sidebar_AccountAddr:  'Dirección de la Cuenta:',
  sidebar_AccountBal:   'Balance de la Cuenta:',
  sidebar_TokenBal:     'Balances de los Tokens:',
  sidebar_Equiv:        'Valores Equivalentes:',
  sidebar_TransHistory: 'Historial de Transacciones',
  sidebar_DGDBal:       'Información del Crowdsale DGD:',
  sidebar_donation:     'MyEtherWallet es un servicio de código abierto gratis, diseñado para proteger tu privacidad y seguridad. Mientras más donaciones recibamos, tendremos más tiempo disponible para crear más características nuevas, escuchar tus sugerencias, y darte lo que necesitas. Sólo somos un par de personas tratando de cambiar al mundo, ¿nos ayudas?',
  sidebar_donate:       'Donar',
  sidebar_thanks:       '¡¡¡MUCHAS GRACIAS!!!',

  /* Decrypt Panel */
  decrypt_Access:         '¿Cómo te gustaría acceder a tu monedero?',
  decrypt_Title:          'Elige el formato de tu llave privada:',
  decrypt_Select:         'Selecciona un monedero:',

  /* Add Wallet */
  ADD_Label_1:            '¿Qué te gustaría hacer?',
  ADD_Radio_1:            'Generar Nuevo Monedero',
  ADD_Radio_2:            'Selecciona tu archivo de Monedero (Llavero / JSON)',
  ADD_Radio_2_short:      'SELECCIONA TU MONEDERO...',
  ADD_Radio_3:            'Pega/Escribe Tu Llave Privada',
  ADD_Radio_4:            'Agrega un Monedero Para Seguirlo',
  ADD_Label_2:            'Crea un Sobrenombre:',
  ADD_Label_3:            'Tu archivo está encriptado. Por favor ingresa la contraseña: ',
  ADD_Label_4:            'Agrega una Cuenta Para Seguirla',
  ADD_Warning_1:          'Puedes agregar cualquier cuenta en "seguimiento" desde la pestaña de monederos, sin necesidad de introducir su llave privada. Esto ** no ** significa que tengas acceso a esta cuenta, ni que podrás retirar los fondos de la misma.',
  ADD_Label_5:            'Introducir la Dirección: ',
  ADD_Label_6:            'Desbloquea tu Monedero',
  ADD_Label_6_short:      'Desbloquear',
  ADD_Label_7:            'Agregar Cuenta',

  /* Generate Wallets */
  GEN_desc:               'Si quieres agregar múltiples monederos, puedes hacerlo desde aquí: ',
  GEN_Label_1:            'Introduce una contraseña fuerte (almenos 9 caracteres)',
  GEN_Placeholder_1:      '!NO OLVIDES TU CONTRASEÑA!',
  GEN_SuccessMsg:         'Éxito! Tu monedero se ha generado.',
  GEN_Warning:            '**Necesitas tu Llavero/Archivo JSON y la contraseña o Llave privada** para acceder a este monedero en el futuro. Por favor, ¡guarda una copia externa de este archivo! No hay forma de recuperar tu monedero si pierdes este archivo. Lée la [pagina de ayuda](https://www.myetherwallet.com/#help) para más instrucciones.',
  GEN_Label_2:            'Guarda tu Llavero/Archivo JSON o Llave Privada. No olvides tu contraseña.',
  GEN_Label_3:            'Guardar tu Dirección.',
  GEN_Label_4:            'Imprimir tu monedero de papel, o almacena una versión de código QR del mismo. (opcional)',

  /* Bulk Generate Wallets */
  BULK_Label_1:           'Número de Monederos a Generar',
  BULK_Label_2:           'Generar Monederos',
  BULK_SuccessMsg:        'Éxito! Tus monederos se han generado.',

  /* Sending Ether and Tokens */
  SEND_addr:             'Para la Dirección: ',
  SEND_amount:           'Cantidad a Enviar: ',
  SEND_amount_short:     'Cantidad',
  SEND_custom:           'Personalizar',
  SEND_gas:              'Gas',
  SEND_generate:         'Generar una Transacción Firmada',
  SEND_raw:              'Transacción en Bruto',
  SEND_signed:           'Transacción firmada',
  SEND_trans:            'Enviar Transacción',
  SEND_TransferTotal:    'Transferir todo el balance disponible',
  SENDModal_Title:       'Advertencia! ',
  /* full sentence reads "You are about to send "10 ETH" to address "0x1234". Are you sure you want to do this? " */
  SENDModal_Content_1:   'Estás a punto de enviar',
  SENDModal_Content_2:   'a la dirección',
  SENDModal_Content_3:   '¿Estás seguro que quieres hacer esto?',
  SENDModal_Content_4:   'NOTA: Si encuentras un error, seguramente necesitas agregar más ETH a tu cuenta para cubrir los costos de gas de la transacción. El gas se paga en ETH.',
  SENDModal_No:          'No, ¡sácame de aquí!',
  SENDModal_Yes:         'Sí, ¡Estoy Seguro! Realiza la transacción.',
  ...
  /* Send Transaction */
  TRANS_desc:            'Si quieres enviar Tokens, por favor usa la página de "Enviar Token".',
